...
const standardReleaseMemberDirectory =
  /^(?:packages\/(?!experimental\/)[^/]+\/[^/]+|apps\/(?!desktop-host$|tauri-desktop$)[^/]+|vendor\/[^/]+)$/
/** Installable desktop application assembled by Tauri rather than published to npm. */
const desktopApplicationDirectory = 'apps/tauri-desktop'
